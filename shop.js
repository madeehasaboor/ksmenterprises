...
function loadProductsFromDatabase() {
    ...
    if (typeof getAllProducts === 'function') {
        ...
        console.error('getAllProducts function not found, using fallback products');
...
function createProductCard(product) {
    ...
    const imageUrl = product.image || 'https://via.placeholder.com/300x200/1a1a1a/fff?text=Product';
    
    card.innerHTML = `
        <div class="product-image">
            <img src="${imageUrl}" alt="${product.name}" onerror="this.src='https://via.placeholder.com/300x200/1a1a1a/fff?text=Product'">
        </div>
